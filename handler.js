...
global.dfail = async (type, m, conn, usedPrefix, command) => {
  ...
  const msg = {
    ...
    unreg: {
      text: `✦ 𝖳𝗎 𝗎𝗌𝗎𝖺𝗋𝗂𝗈 𝗇𝗈 𝖾𝗌𝗍𝖺́ 𝗋𝖾𝗀𝗂𝗌𝗍𝗋𝖺𝖽𝗈.\n𝖯𝗋𝖾𝗌𝗂𝗈𝗇𝖺 𝖾𝗇 𝖾𝗅 𝖻𝗈𝗍𝗈́𝗇 𝗉𝖺𝗋𝖺 𝗋𝖾𝗀𝗂𝗌𝗍𝗋𝖺𝗋𝗍𝖾.`,
      button: {
        buttonText: '📝 Registrarme',
        command: `${usedPrefix}reg ${user2}.18`
}
},
